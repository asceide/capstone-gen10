...
import { Select, MenuItem, FormHelperText, InputLabel, Input, Button, Typography } from '@mui/material';
...
export default function CreateAccount() {
    ...
    return (
        <>  <div className='container mt-3'>
            ...
            <div className="container mt-5 d-flex justify-items-center">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='form-group d-flex'>
                        ...
                        <div className='mr-3'>
                            ...
                            <Select id="state" name="state" defaultValue='' {...register("state", {
                                validate: (value) => {
                                    if (value) {
                                        if (!getValues("city")) {
                                            return false;
                    ...
                    <Button type="submit" variant="contained" color="inherit" className='mr-2'>Submit</Button>
                    <Link to="/"><Button variant="contained" color="error">Cancel</Button></Link>
                </form>
                <div>
