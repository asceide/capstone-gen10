...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/api/user/").permitAll() // Can only be done by authenticated users in the future
                .antMatchers(HttpMethod.PUT, "/api/user/").permitAll() // Can only be done by authenticated users in the future
                .antMatchers(HttpMethod.DELETE, "/api/user/**").permitAll() // Can only be done by admins in the future
                .antMatchers("/**").denyAll()
